...
/// <summary>
/// Represents a service that provides generative AI chat completion functionality.
/// </summary>
public interface IChatService
{
    /// <summary>
    /// Sends a request to the chat client to get a text completion for the provided <paramref name="imageBytes"/> and <paramref name="imageMime"/>.
    /// </summary>
    /// <param name="imageBytes">The image byte data to roast.</param>
    /// <param name="imageMime">The MIME type of the image.</param>
    ...
    /// <returns>The completion text generated by the chat client.</returns>
    Task<string> GetCompletion(byte[] imageBytes, string imageMime, CancellationToken cancellationToken = default);
}

/// <summary>
/// The <see cref="IChatService"/> implementation that uses a <see cref="IChatClient"/> to get a text completion.
/// </summary>
/// <param name="client">The <see cref="IChatClient"/> instance to send the prompts to and generate the responses.</param>
